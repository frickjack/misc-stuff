...
['apt-file', 'build-essential', 'dnsutils', 'figlet', 'git', 'gpg', 'jq', 'ldap-utils', 'less', 'nano', 'nodejs', 'python-dev', 'python-pip', 'python3-dev', 'python3-pip', 'unzip', 'vim', 'xclip', 'zip'].each do |name|
